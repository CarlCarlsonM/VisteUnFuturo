...
Proyecto de desarrollo del Ciclo 3 de Mision TIC / Software project part of the 3rd cicle of the Mision TIC program
...
```
java -Dspring.profiles.active=production -jar ./target/viste-un-futuro-0.0.1-SNAPSHOT.jar
```
